...
// Feature routes (outside modules — auto-registered from app/features/**/routes/*.routes.ts)
import visitsRouter from "~/features/visits/routes/visits.routes";
import communityRouter from "~/features/community/routes/community.routes";
