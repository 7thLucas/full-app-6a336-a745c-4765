...
// Feature seeds (outside modules — imported directly)
import { seedCommunityRatings } from "~/features/visits/seeds/visits.seed";
...
export async function runSeeds(): Promise<void> {
  ...
  try {
    // Run feature seeds directly
    await seedCommunityRatings();

    // Run module seeds (auto-discovered)
