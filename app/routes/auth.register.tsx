    ...
    >
      ...
      >
        <h2
          ...
          style={{ fontFamily: "'Playfair Display', serif", color: primaryColor }}
        >
          Start your coffee atlas
        </h2>
        <p className="text-sm mb-5" style={{ color: textSecondary }}>Create your free account</p>
        ...
        <Form method="post" className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium mb-1.5" style={{ color: primaryColor }}>Username</label>
            <input
              name="username"
              type="text"
          ...
          <div>
            <label className="block text-sm font-medium mb-1.5" style={{ color: primaryColor }}>Password</label>
            <input
              name="password"
              type="password"
              required
          ...
          <button
            ...
            style={{ backgroundColor: accentColor, color: "#fff", boxShadow: `0 4px 16px ${accentColor}44` }}
          >
        ...
        <p className="text-center text-sm mt-5" style={{ color: textSecondary }}>
          ...
          <Link to="/auth/login" className="font-semibold" style={{ color: accentColor }}>
            Sign in
          </Link>
        </p>
      </div>
